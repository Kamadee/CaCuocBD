                                    ...
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <form action="{{ route('authentication.postRegister') }}" method="POST" class="mx-1 mx-md-4">
                                            ...
                                            <!-- <div class="d-flex flex-row align-items-center mb-4">
                                                <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                                <div class="form-outline flex-fill mb-0">
                                                    <input name="phone" type="number" id="form3Example1c" class="form-control" />
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input name="email" type="email" name="email" required id="form3Example3c" class="form-control" />
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input name="re-pass" type="password" id="form3Example4cd" class="form-control" />
